      ...
      <div>
        ...
        <div className='flex gap-2'>
          <label htmlFor="image1">
            <img className='w-25' src={!image1 ? assets.upload_area : URL.createObjectURL(image1)} alt='UPLOAD AREA'/>
            <input onChange={(e)=>setImage1(e.target.files[0])} type='file' id='image1' hidden></input> 
          </label>

          <label htmlFor="image2">
            <img className='w-25' src={!image2 ? assets.upload_area : URL.createObjectURL(image2)} alt='UPLOAD AREA'/>
            <input onChange={(e)=>setImage2(e.target.files[0])} type='file' id='image2' hidden></input> 
          </label>

          <label htmlFor="image3">
            <img className='w-25' src={!image3 ? assets.upload_area : URL.createObjectURL(image3)} alt='UPLOAD AREA'/>
            <input onChange={(e)=>setImage3(e.target.files[0])} type='file' id='image3' hidden></input> 
          </label>

          <label htmlFor="image4">
            <img className='w-25' src={!image4 ? assets.upload_area : URL.createObjectURL(image4)} alt='UPLOAD AREA'/>
